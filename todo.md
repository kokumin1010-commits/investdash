...
- [ ] 为全部适用持仓补齐真实投资卡，并提供待生成、失败冷却与重试状态
- [ ] 自动核验价格带确认项，保存逐项证据、结论、时间与失败原因（代码完成，待生产回填）
- [x] 持久化价格、新闻、资料、信号、计划、投资卡与核验任务的每次运行记录
- [x] 新增日文调度运行记录管理页，支持任务、状态、时间与失败筛选
- [x] 为投资卡、价格带核验、调度日志服务、路由和页面补充 Vitest/DOM 测试（103 文件、969 项）
- [ ] 部署 Railway 并完成真实投资卡回填与 51 个价格带确认项生产核验
- [ ] 在桌面与 390px 手机生产页面验收投资卡、确认项和调度管理页
- [ ] 更新审计与运维文档，保存最终检查点并交付
